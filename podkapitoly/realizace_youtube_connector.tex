...
\par Regulární výraz\cite{regexp} je matematický formalismus pro popis slov/vět jazyků\note{Přímo definice od Ing. Jana Trdličky}. Jedná se tedy o způsob jak formálně popsat určité slovo, případně větu pomocí formálního vyjádření speciálními symboly a~skupinami znaků. V Ruby\cite{ruby} je popis regulárním výrazem uvozen / na začátku a~/ na konci. Pomocí dvou lomítek řekneme překladači, že zápis uvnitř lomítek má považovat za regulární výraz.
