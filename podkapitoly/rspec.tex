...
%end
%\end{minted}
\par Dále můžeme deklarovat vnořené skupiny pomocí klíčových slov describe, nebo context. Tato klíčová slova nakonec zavolají příslušné metody, což je pro programátora skryto jazykem DSL, kterým popis testů v systému RSpec rozhodně je.
\begin{minted}{ruby}
RSpec.describe Order do
